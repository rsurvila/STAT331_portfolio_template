...
#Lab 3. This code chunk shows that I can select specified columns and filter from the teacher_evals dataset for the amount of participants to be greater than 10.
