...
-   Example 1
    -   Lab 1. Attached as a file in my Git repository.
-   Example 2
    -   Lab 2. Attached as a file in my Git repository.
-   Example 3
    -   Challenge 2. Attached as a file in my Git repository.
-   Example 4
    -   Lab 4. Attached as a file in my Git repository.
    -   Changed my original lab to include table and figure captions.
-   Example 5
    -   Challenge 4. Attached as a file in my Git repository.
    -   Changed my original lab to include table and figure captions.
